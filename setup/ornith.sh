...
# ==============================================================================
# Ornith-1.5-35B-A3B APEX-I (Dual Preset: Agent vs. Creative)
...
PORT=8080
HOST="127.0.0.1"
MODEL_PATH="/home/user/models/Ornith-1.5-35B-A3B-APEX-I-Compact.gguf"
ALIAS="Ornith-1.5-35B-A3B"

LOG_DIR="/home/user/models/serv"
LOG_FILE="$LOG_DIR/ornith-server.log"
...
ENABLE_LOG=false     # true: write to ornith-server.log | false: live output
...
SERVER_ARGS=(
  ...
  # ── Autonomous Engineering Agent (Official DeepReinforce Scaffolding) ──
  --reasoning on
  ...
  # ── Mode 2: Chat & Creative / Unconstrained ──
